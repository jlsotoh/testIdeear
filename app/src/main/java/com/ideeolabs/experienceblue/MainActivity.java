package com.ideeolabs.experienceblue;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnExp = findViewById(R.id.button);
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(mMessageReceiver,
                new IntentFilter("ideearMessage"));
    }
    ...
    private void abrirExperiencia() {
        ...
        try {
            ...
            //iFW.putExtra(clInit.COLOR_BAR, colorbar);
            //iFW.putExtra(clInit.TITLE, "Blue Experience");
